...
@app.route("/")
def home():
    return 'This is home page for no path, <h2> Welcome Home</h2>' 
...
if __name__== "__main__":
    #app.run(debug=True,port=2000) # Localden projeyi run edebilmemiz icin kullandıgımız kod blogu
    app.run(host='0.0.0.0', port=80) # Boylelikle EC2 makineden calistirtabliriz